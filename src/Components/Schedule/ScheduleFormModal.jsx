  ...
  return (
    <div className={`modal fade`} id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div className="modal-dialog">
        <div className={`modal-content ${tema ? '' : styles.DarkModal}`}>
          
          <div className="modal-header">
            <h1 className="modal-title fs-5" id="exampleModalLabel">Selecione o dentista, paciente e a data e hora</h1>
            <button type="button" className={`btn-close ${tema ? `` : styles.closeButtonDark }`} data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
